...
import com.ssm.eduservice.client.UcenterClient;
import com.ssm.eduservice.entity.EduComment;
import com.ssm.eduservice.service.EduCommentService;
...
public class EduCommentController {
    ...
    public R save(@RequestBody EduComment comment, HttpServletRequest request) {
        ...
        if (StringUtils.isEmpty(memberId)) {
            return R.error().code(20001).message("请登录再评论");
        }
        UcenterMemberOrder ucenterInfo = ucenterClient.getUserInfoOrder(memberId);
        comment.setMemberId(memberId);

        System.out.println(ucenterInfo.getNickname());
